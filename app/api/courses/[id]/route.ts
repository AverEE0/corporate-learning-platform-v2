...
export async function GET(
  ...
  try {
    ...
    // Менеджеры и админы могут видеть все курсы, включая черновики других менеджеров
    if (course.status === 'draft') {
      ...
      // Менеджеры и админы могут видеть все черновики
      // Студенты не могут видеть черновики
      ...
      // Менеджеры и админы могут видеть все черновики (но редактировать/удалять могут только свои)
      // Эта проверка уже пройдена выше для студентов
    }
